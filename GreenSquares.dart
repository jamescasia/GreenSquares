...
class GreenSquares extends StatefulWidget {
  ...
  @override
  _GreenSquaresState createState() => new _GreenSquaresState(
          ...
          Padding(
              ...
              child: Container(
                  ...
                  child: GridView.count(
                    crossAxisCount: 5,
                    children: List.generate(squareList.length - 1, (index) {
                      // index += 1;
                      ...
                      return Tooltip(
                          ...
                          child: Padding(
                              ...
                              child: Container(
                                ...
                                width: 2,
                                constraints:
                                    BoxConstraints.expand(width: 2, height: 2),
                                color: Colors.grey[200],
                                child: Container(
                                  color: squareColor.withOpacity(
                                      (squareList[index].percentToMax) / 6.0),
                                ),
